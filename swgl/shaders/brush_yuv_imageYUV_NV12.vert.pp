...
void brush_vs(
    ...
    if(vFormat == 1){
        write_uv_rect(prim_user_data . x, f, vec2(textureSize(sColor0, 0). xy), vUv_Y, vUvBounds_Y);
        write_uv_rect(prim_user_data . y, f, vec2(textureSize(sColor1, 0). xy), vUv_U, vUvBounds_U);
        write_uv_rect(prim_user_data . z, f, vec2(textureSize(sColor2, 0). xy), vUv_V, vUvBounds_V);
    } else if(vFormat == 0){
        write_uv_rect(prim_user_data . x, f, vec2(textureSize(sColor0, 0). xy), vUv_Y, vUvBounds_Y);
        write_uv_rect(prim_user_data . y, f, vec2(textureSize(sColor1, 0). xy), vUv_U, vUvBounds_U);
    } else if(vFormat == 2){
