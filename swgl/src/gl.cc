...
static ALWAYS_INLINE int check_depth8(uint16_t z, uint16_t* zbuf, ZMask8& outmask) {
...
static ALWAYS_INLINE bool check_depth4(uint16_t z, uint16_t* zbuf, ZMask4& outmask, int span = 0) {
